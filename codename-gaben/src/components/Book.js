...
const Modal = (props) => {
	return (
		<div className="modal hidden fixed bottom-0 inset-x-0 px-4 pb-4 sm:inset-0 sm:flex sm:items-center sm:justify-center">
						...
						<div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
							...
							<div className="mt-2">
								<p className="text-sm leading-5 text-gray-500">
									...
									permanantly removed. This action cannot be
									undone.
								</p>
							</div>
						</div>
